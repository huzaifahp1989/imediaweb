...
export default function AdminAudioContent() {
  ...
  const subject = encodeURIComponent("Admin Access Request - Audio Content");
  const body = encodeURIComponent("Hi, I'd like admin access to manage audio content on Islam Kids Zone. My name is ____ and my contact details are ____.");
        ...
        <Card className="border-2 border-blue-300 shadow-lg bg-gradient-to-br from-blue-50 to-purple-50">
          ...
          <CardContent className="text-center">
            <p className="text-gray-700 mb-4">
              The Audio Content panel is disabled in this email-only mode. Please request admin access.
            </p>
            <Button
              onClick={() => {
